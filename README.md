...
cd backend
mvn clean package
java -jar target/reminot-1.0.9.jar
```
...
Готовый файл:
- `backend/target/reminot-1.0.9.jar`
...
```powershell
cd backend
.\build-exe.ps1 -AppVersion 1.0.9
```
...
```powershell
.\build-exe.ps1 -AppVersion 1.0.9 -IconPath "..\docs\media\my-icon.ico"
```
