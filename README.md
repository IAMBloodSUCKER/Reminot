...
cd backend
mvn clean package
java -jar target/reminot-1.0.6.jar
```
...
Готовый файл:
- `backend/target/reminot-1.0.6.jar`
...
```powershell
cd backend
.\build-exe.ps1 -AppVersion 1.0.6
```
...
```powershell
.\build-exe.ps1 -AppVersion 1.0.6 -IconPath "..\docs\media\my-icon.ico"
```
