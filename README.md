...
cd backend
mvn clean package
java -jar target/reminot-1.0.7.jar
```
...
Готовый файл:
- `backend/target/reminot-1.0.7.jar`
...
```powershell
cd backend
.\build-exe.ps1 -AppVersion 1.0.7
```
...
```powershell
.\build-exe.ps1 -AppVersion 1.0.7 -IconPath "..\docs\media\my-icon.ico"
```
