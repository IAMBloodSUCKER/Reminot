...
[![Release](https://img.shields.io/badge/Release-v1.0.15-lightgrey?style=for-the-badge)](https://github.com/IAMBloodSUCKER/Reminot/releases/latest)
...
cd backend
mvn clean package
java -jar target/reminot-1.0.15.jar
```
...
Готовый файл:
- `backend/target/reminot-1.0.15.jar`
...
```powershell
cd backend
.\build-exe.ps1 -AppVersion 1.0.15
```
...
```powershell
.\build-exe.ps1 -AppVersion 1.0.15 -IconPath "..\docs\media\my-icon.ico"
```
...
```bash
git add .
git commit -m "Prepare release v1.0.15"
