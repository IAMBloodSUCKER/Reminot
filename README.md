...
cd backend
mvn clean package
java -jar target/reminot-1.0.8.jar
```
...
Готовый файл:
- `backend/target/reminot-1.0.8.jar`
...
```powershell
cd backend
.\build-exe.ps1 -AppVersion 1.0.8
```
...
```powershell
.\build-exe.ps1 -AppVersion 1.0.8 -IconPath "..\docs\media\my-icon.ico"
```
